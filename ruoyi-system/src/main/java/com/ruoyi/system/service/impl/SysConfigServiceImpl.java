...
public class SysConfigServiceImpl implements ISysConfigService
{
    ...
    @Value("${ruoyi.login.captchaEnabledOverride:}")
    private String captchaEnabledOverride;
    ...
    public void init()
    {
        ...
        {
            log.warn("Skip config cache preload because sys_config is unavailable yet: {}", e.getMessage());
        }
    }
