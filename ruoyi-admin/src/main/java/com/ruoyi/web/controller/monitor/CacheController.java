...
public class CacheController
{
    ...
    public AjaxResult getInfo() throws Exception
    {
        ...
        result.put("mode", redisCache.isLocalMode() ? "local" : "redis");
        result.put("dbSize", redisCache.size());
        result.put("info", Map.of(
                "cacheMode", redisCache.isLocalMode() ? "local" : "redis",
                "description", redisCache.isLocalMode() ? "当前为本地内存缓存模式" : "当前为Redis缓存模式"));
