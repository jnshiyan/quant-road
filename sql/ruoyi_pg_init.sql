...
insert into sys_menu values('2', '系统监控', '0', '2', 'monitor',          null, '', '', 1, 0, 'M', '1', '0', '', 'monitor',  'admin', CURRENT_TIMESTAMP, '', null, '系统监控目录（初始化默认隐藏）');
insert into sys_menu values('3', '系统工具', '0', '3', 'tool',             null, '', '', 1, 0, 'M', '1', '0', '', 'tool',     'admin', CURRENT_TIMESTAMP, '', null, '系统工具目录（初始化默认隐藏）');
insert into sys_menu values('4', '若依官网', '0', '4', 'http://ruoyi.vip', null, '', '', 0, 0, 'M', '1', '0', '', 'guide',    'admin', CURRENT_TIMESTAMP, '', null, '若依官网地址（初始化默认隐藏）');
-- 二级菜单
...
-- ----------------------------
-- 5、 Trigger 作为 bytea 类型存储(用于 Quartz 用户用 JDBC 创建他们自己定制的 Trigger 类型，JobStore 并不知道如何存储实例的时候)
-- ---------------------------- 
...
-- ----------------------------
-- 6、 以 bytea 类型存储存放日历信息， quartz可配置一个日历来指定一个时间范围
-- ---------------------------- 
